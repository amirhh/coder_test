            ...
            <Modal style={{ height: '85vh', minWidth: '65vw', direction: 'ltr' }} isOpen={this.state.modal} toggle={this.toggle} className={this.props.className}>
              ...
              <ModalBody>
                ...
                <figure style={{ display: 'flex', justifyContent: 'space-around', height: 300 }}>
                  <img src={require('./../../assets/img/ios.png')} onClick={() => this.toggle("ios")} className="img_os_selection" style={{ cursor: 'pointer', height: '100%' }} />
                  <img src={require('./../../assets/img/android.png')} onClick={() => this.toggle("android")} className="img_os_selection" style={{ cursor: 'pointer', height: '100%' }} />
                </figure>
              </ModalBody>
          ...
          <div className="animated fadeIn">
            <Card data-dark="true" data-bg={Gstate.darkBg_default} >
              <CardHeader id="headingOne" style={{ display: 'flex', justifyContent: 'space-between' }} >
                ...
                <strong> مجموع : {this.state.sum}</strong>
              </CardHeader>
              <CardBody>
                <Table data-dark="true" data-bg={Gstate.darkBg_table} data-dark="true" data-bg={Gstate.darkBg_table} hover style={{ textAlign: 'center' }}>
                  <thead>
                ...
                <span style={{ float: 'left', padding: 10, backgroundColor: 'darkseagreen', borderRadius: 6 }} > مجموع : {this.state.sum}</span>
              </CardBody>
            </Card>
            <ToastContainer />
